  ...
  return (
    <div className="lg:grid grid-cols-2 gap-0 transform">
      <div className="pr-6 transform md:-translate-x-4">
        <Image
          className="h-auto max-w-full rounded-2xl md:rounded-huge pr-6"
          objectFit="cover"
          src={TeachersMeeting2}
          alt="Teachers Meetings"
        />
      </div>
      <div className="flex justify-center md:p-6 flex-col md:w-2/3 md:ml-16 md:mt-0 mt-12">
        ...
        <Fade delay={300}>
          <p className="leading-7 my-3">
            The New Castle Federation of Teachers is a union of professionals that champions fairness; democracy;
